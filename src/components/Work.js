...
const Work = () => (
  <section className="p-6 bg-gray-100 dark:bg-gray-800 rounded-md shadow-md">
    ...
    <div className="mb-6">
    <div>
      <h2 className="text-xl font-semibold">YOUYUGIOH</h2>
      <p>Developed a large scale E-Commerce website for a fictional Winniepg based location, selling YuGiOh cards as their main source of product.</p>
      <p>Tech List: Rails, Ruby, Bulma, Stripe, Devise.</p>
    </div>
    <div>
