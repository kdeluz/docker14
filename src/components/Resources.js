...
const Resources = () => (
  <section className="p-6 bg-gray-100 dark:bg-gray-800 rounded-md shadow-md">
    ...
    <div className="mb-6">
      ...
      <a href="https://github.com/kdeluz" className="text-blue-500 dark:text-blue-300">View GitHub Profile</a>
    </div>
    <div>
      ...
      <a href="https://www.linkedin.com/in/kdeluz/" className="text-blue-500 dark:text-blue-300">View LinkedIn Profile</a>
    </div>
  </section>
);
